...
- With the exception of table of contents-style sections (for example, in this
  document), always use reference-style links
...
- The appendix should only reflect the discussion on the cited sources, rather
